            ...
            <div className="relative w-3/5 mr-4">
              {track.length > 0 ? (
                <button
                  ...
                  id="dropdownToggle"
                  onClick={handleClick}
                  className="h-8 text-start pl-3 text-sm w-full border rounded-lg border-gray-300"
                >
                  {track.join(", ")}
                </button>
              ) : (
              ...
              <ul
                ref={dropdownRef}
                id="dropdownMenu"
                className="absolute hidden bg-neutral rounded-lg py-2 px-2 z-[1000] w-full shadow"
              >
                <li>
