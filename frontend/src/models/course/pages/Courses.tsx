                    ...
                    <Fragment key={trackName}>
                        ...
                        {courses && courses.map((course, index) =>
                            ...
                            <div key={index} className="flex justify-between items-center">
                                <Link to={`/courses/details/${course.id}`} key={course.name + index} className={`flex justify-between items-center bg-white w-full rounded-l-md drop-shadow-xl ${isLoading ? "cursor-default pointer-events-none" : "hover:bg-[#F9F9F9]"}`}>
