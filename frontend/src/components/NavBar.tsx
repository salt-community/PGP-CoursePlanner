  ...
  return (
    <div className={`fixed flex flex-col left-0 top-0 h-full bg-[#ff7961] text-white shadow-lg transition-all duration-200 ${isSidebarExpanded ? 'w-64' : 'w-20'}`}>
      ...
      <ul className="menu menu-vertical text-center p-0 text-lg overflow-hidden">
        <li className="hover:rounded-none pl-1">
          <NavLink
            to={`/`}
            className={({ isActive }) => isActive ? "flex pl-5 text-xl bg-primary-content rounded-none" : "flex pl-5 text-xl rounded-none"}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
        ...
        <li className="hover:rounded-none pl-1">
          <NavLink
            to="/activecourses"
            className={({ isActive }) => isActive && !bootcampDetailsIsActive ? "flex pl-5 text-xl bg-primary-content rounded-none" : "flex pl-5 text-xl rounded-none"}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
      ...
      <div className="flex-grow"></div>
        ...
        <button className={`btn btn-secondary m-4 text-xl p-0 flex-nowrap overflow-hidden ${isSidebarExpanded && "min-w-32"}`} onClick={handleLogOut}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
