...
namespace Backend.ExceptionHandler.Exceptions
{
    public class NotFoundByIdException : NotFoundException<int>
    {
        ...
        { }
        public NotFoundByIdException(string resourceName, int resourceId) : base(resourceName, resourceId)
        { }
        public NotFoundByIdException(string resourceName, int resourceId, Exception inner) : base(resourceName, resourceId, inner)
        { }
